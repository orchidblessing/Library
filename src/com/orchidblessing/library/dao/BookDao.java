...
public class BookDao {
    ...
    public int addBook(Book book) {
        ...
        int bookId = DataBaseUtils.commonUpdateSql(sql,arrayList);
        book.setId(bookId);
        return bookId;
    }
    ...
    public Book getBookByName(String bookName) {
        String queryBookSql = "select id, book_name as bookName, author, press, price, stock, borrow_count as borrowCount from lib_book where book_name='"+bookName+"';";
        List<Book> books = DataBaseUtils.commonQuery(Book.class,queryBookSql);
        return books.isEmpty() ? null : books.get(0);
    }

    public List<Book> listBookByAuthor(String author) {
        String queryBookSql = "select id, book_name as bookName, author, press, price, stock, borrow_count as borrowCount from lib_book where author='"+author+"';";
        return DataBaseUtils.commonQuery(Book.class, queryBookSql);
    }
    ...
    public int delBook(String bookName) {
        ...
        return DataBaseUtils.commonUpdateSql(sql, arrayList);
    }
